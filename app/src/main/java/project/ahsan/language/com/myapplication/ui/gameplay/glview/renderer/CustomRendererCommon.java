...
public class CustomRendererCommon implements GLSurfaceView.Renderer {
    ...
    public CustomRendererCommon(Context context, float width, float height) {
    ...
    protected String getVertexShader() {
        return RawResourceReader.readTextFileFromRawResource(mActivityContext, R.raw.vertex_shader_common);
    }

    protected String getFragmentShader() {
        return RawResourceReader.readTextFileFromRawResource(mActivityContext, R.raw.fragment_shader_common);
    }
